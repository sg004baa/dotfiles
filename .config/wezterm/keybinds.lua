...
return {
  keys = {
    ...
    { key = 'F', mods = 'SHIFT|CTRL', action = act.SendString '\x1b[70;5u' },
    ...
    -- { key = 'J', mods = 'ALT', action = wezterm.action.SendKey { key = "5j" }},
    -- { key = 'K', mods = 'ALT', action = wezterm.action.SendKey { key = "5k" }},
